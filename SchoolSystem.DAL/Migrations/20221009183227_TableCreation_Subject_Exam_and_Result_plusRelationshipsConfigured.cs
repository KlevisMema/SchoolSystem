...
{
    public partial class TableCreation_Subject_Exam_and_Result_plusRelationshipsConfigured : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Subjects_Clasrooms_ClasroomId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Results", x => new { x.StudentId, x.ExamId, x.SubjectId });
                    table.ForeignKey(
