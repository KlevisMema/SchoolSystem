...
{
    /// <summary>
    ///     Create attendance command handler class which implements IRequestHandler which gets the get create attendance command and object result as response 
    /// </summary>
    public class CreateAttendanceCommandHandler : IRequestHandler<CreateAttendanceCommand, ObjectResult>
    {
        ...
        /// <summary>
        ///     Handle the create attendances command
        /// </summary>
