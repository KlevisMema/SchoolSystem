...
namespace SchoolSystem.BLL.RepositoryService
{
    public class StudentClasroomService : ICrudService<StudentClasroomViewModel, CreateUpdateStudentClasroomViewModel>
    {
        ...
        public async Task<Response<StudentClasroomViewModel>> GetRecord(Guid id)
        {
        ...
        public async Task<Response<StudentClasroomViewModel>> PutRecord(Guid id, CreateUpdateStudentClasroomViewModel viewModel)
        {
        ...
        public async Task<Response<StudentClasroomViewModel>> PostRecord(CreateUpdateStudentClasroomViewModel viewModel)
        {
        ...
        public async Task<Response<StudentClasroomViewModel>> DeleteRecord(Guid id)
        {
